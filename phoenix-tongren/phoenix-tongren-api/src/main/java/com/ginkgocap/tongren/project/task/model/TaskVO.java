...
public class TaskVO implements Serializable{
	...
	private boolean isRequreRemind=true;
	...
	public boolean isRequreRemind() {
		return isRequreRemind;
	}

	public void setRequreRemind(boolean isRequreRemind) {
		this.isRequreRemind = isRequreRemind;
	}
